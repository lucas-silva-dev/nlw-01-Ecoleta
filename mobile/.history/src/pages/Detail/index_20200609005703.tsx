...
import { Feather as FeIcon, FontAwesome as FaIcon } from "@expo/vector-icons";
import {
  View,
  StyleSheet,
  Text,
...
const Detail: React.FC = () => {
  ...
  useEffect(() => {
    async function loadPoint() {
      const { point } = api.get(`points/${routeParams.point_id}`);
  ...
  if (!pointData.point) {
    return (
      <ActivityIndicator color="#34cb79" size={64} style={{ marginTop: 72 }} />
    );
  }
